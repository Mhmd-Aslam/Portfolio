...
export const options = {
	...
	csp: {"mode":"hash","directives":{"default-src":["'self'"],"frame-src":["'self'","vercel.live"],"connect-src":["'self'"],"font-src":["'self'","fonts.gstatic.com"],"img-src":["'self'","data:","blob:"],"script-src":["'self'","cdnjs.cloudflare.com","cdn.jsdelivr.net","vercel.live"],"style-src":["'self'","'unsafe-inline'","fonts.googleapis.com"],"base-uri":["'none'"],"frame-ancestors":["'none'"],"upgrade-insecure-requests":false,"block-all-mixed-content":false},"reportOnly":{"upgrade-insecure-requests":false,"block-all-mixed-content":false}},
